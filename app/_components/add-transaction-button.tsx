...
const formSchema = z.object({
  ...
  paymentMethod: z.nativeEnum(TransactionPaymentMethod, {
    required_error: "Selecione o meio de pagamento.",
  }),
  date: z.date({
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  >
                    <FormControl>
                      <SelectTrigger>
                        <SelectValue placeholder="Selecione o tipo de Transação"></SelectValue>
                      </SelectTrigger>
                    </FormControl>
                    <SelectContent>
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  >
                    <FormControl>
                      <SelectTrigger>
                        <SelectValue placeholder="Selecione o meio de pagamento"></SelectValue>
                      </SelectTrigger>
                    </FormControl>
                    <SelectContent>
